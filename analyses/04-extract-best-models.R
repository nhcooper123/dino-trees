...
#-------------------------------------
# Read in data
ds_saka_o <- read_csv("outputs/mcmcglmm_outputs_offset_sakamoto.csv")
...
# With intercepts
#-------------------------------------
plot_data_o <- rbind(to_plot_o, to_plot_saka_o)
...
plot_data_o <-
  ...
  mutate(tree = case_when(tree == "Arbour.phy.nex" ~ "Arbour",
                          ...
                          tree == "lloyd" ~ "Lloyd"))
# Write to file
write_csv(plot_data_o, path = "outputs/best-models-offset.csv")
