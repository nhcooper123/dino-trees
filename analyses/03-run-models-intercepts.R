# Analysis step 3
# Run all the models on all the simulated trees with intercepts fitted
# Natalie Cooper Feb 2018
...
# Run the models
model.outputs <- run_three_models_intercept(tree, nodecount.data, prior, nitt, thin, burnin)

# Add model outputs
output2 <- add_mcmc_output_intercept(output2, null.model = model.outputs[[1]], 
...
write.csv(file = "outputs/mcmcglmm_outputs_intercepts.csv", output2, 
