...
make_predictions_figures_intercepts <- function(treename, tree, rep, col1, col2){
...
write.csv(file = paste0("outputs/tables/inflection_", treename, "_intercepts.csv"),
...
ggsave(file = paste0("outputs/figures/", treename, "_intercepts.pdf"), allplots)
